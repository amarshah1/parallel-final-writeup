...
We find that we plateau achieves speedups of up to TODO on 32 cores, TODO on 64
cores, and TODO on 128 cores for the Herbie benchmarks. The speedup is not as
high as on the synthetic benchmarks, likely because the Herbie benchmarks have
fewer merges per round and more rounds of congruence closure, which leads to
higher overheads in our parallel algorithm. However, we still see a significant
performance improvement over the sequential version, demonstrating the potential
of our parallel congruence closure algorithm in real-world applications.
